...
return [
    ...
    'attributes' => [
        ...
        'due_at' => 'Fällig am',
        'client_company' => 'Kunde - Firmenname',
        'client_address_line1' => 'Kunde - Straße + Hausnummer',
        'client_postal_code' => 'Kunde - Postleitzahl',
        'client_city' => 'Kunde - Stadt',
        ...
        'client_tax_number' => 'USt-IdNr',
        'project_name' => 'Projektname',
        'client_street' => 'Straße',
        'client_contact_person' => 'Ansprechpartner',
        'client_contact_person_salutation' => 'Akademischer Titel',
        'client_contact_person_gender' => 'Anrede',
        'project_description' => 'Projektbeschreibung',
        'i_have_read_the_offer' => 'Ich habe das Angebot durchgelesen und nehme dieses verbindlich an'
    ],
];
