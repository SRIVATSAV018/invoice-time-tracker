                            ...
                            <tr>
                                <td class="content-cell"
                                    ...
                                    <p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                        vielen Dank - Sie haben das Angebot für das Projekt "{{ $offer->project_name }}" am {{ $offer->accepted_at->format('d.m.Y') }} erfolgreich angenommen.
                                    </p>

                                    <p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                        Die Zusammenarbeit kann ich wie vereinbart beginnen.
                                    </p>
                                    <p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                        Zusammenfassung des bestätigten Angebots: <br>
                                        <b>Angebotsnr.:</b> {{ $offer->offer_number }} <br>
                                        ...
                                        <b>Nettobetrag:</b> {{ number_format($offer->net_total, 2, ',', '.') }} €<br>
                                        <b>Bruttobetrag (inkl. MwSt.):</b> {{ number_format($offer->gross_total, 2, ',', '.') }} €
                                    </p>
                                    <p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                        Eine Kopie des Angebots finden Sie im Anhang dieser E-Mail.
                                    </p>
                                    <p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                        Ich werde Sie in den kommenden Tagen bezüglich der weiteren Schritte kontaktieren.
                                    </p>

                                    <p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                        Wenn Sie vorab noch Fragen oder Wünsche haben, können Sie sich jederzeit gern melden.
                                    </p>

                                    <p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                        Freundliche Grüße<br>
                                        {{ $user->name }} <br>
                                        <small>Freiberuflicher Webentwickler</small> <br>
